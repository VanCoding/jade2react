...
Compilation.prototype.compile = function(){
    ...
    this.block.writeLine("");
    this.block.writeLine("var Component = React.createFactory(React.createClass((function(){var props = {};for(var prop in module.exports){props[prop] = module.exports[prop]};return props})()));")
...
Compilation.prototype.renderMixin = function(node){
    if(node.call){
        ...
        this.block.writeLine("exports."+node.name+" = function(block,attributes"+argparts[0]+"){",1);
...
Compilation.prototype.renderExtends = function(node){
    this.extendblock.writeLine("jade2react.mixin(require(\""+node.path+"\"),module.exports);");
