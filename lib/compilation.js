...
function Compilation(doc){
    this.tree = parse(lex(fs.readFileSync(resolve.sync(path,base?{basedir:dirname(base)}:undefined))+"")).nodes;
    Block.call(this);
    this.script = new Block();
}

Compilation.prototype = Object.create(Block);
